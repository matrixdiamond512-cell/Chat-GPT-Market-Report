...
function buildWebReportReadablePreviewHtml_(file, report) {
  return [
    ...
    '<base target="_top">',
    '<style>',
    'body{margin:0;background:#f7f9fd;color:#061b45;font-family:Arial,"Hiragino Kaku Gothic ProN","Yu Gothic",Meiryo,sans-serif;font-size:15px;line-height:1.9;}',
    '.wrap{padding:22px 22px 28px;}',
    '.article{max-width:920px;margin:0 auto;background:#fff;border:1px solid #d7e2f3;border-radius:10px;padding:26px 30px;box-shadow:0 8px 24px rgba(15,45,90,.06);}',
    '.hero{border-bottom:2px solid #1264df;padding-bottom:16px;margin-bottom:22px;}',
    '.hero h1{font-size:25px;line-height:1.35;margin:0 0 10px;color:#001f55;}',
    '.meta{display:flex;flex-wrap:wrap;gap:8px 18px;font-size:12px;color:#536985;}',
    '.meta a{color:#fff;text-decoration:underline;}',
    '.meta a{color:#0057cf;text-decoration:underline;}',
    '.section{border-top:1px solid #dce6f5;padding-top:22px;margin-top:22px;}',
    '.section:first-of-type{border-top:0;padding-top:0;margin-top:0;}',
    '.section h2{border-left:4px solid #1264df;font-size:18px;line-height:1.35;margin:0 0 16px;padding-left:10px;color:#003b95;}',
    'p{margin:0 0 13px;}',
    'ul{margin:0 0 4px;padding-left:22px;}',
    'li{margin:0 0 9px;}',
    '.market-grid{display:block;}',
    '.market-card{border-left:3px solid #c8dbf5;padding:2px 0 12px 14px;margin:0 0 18px;}',
    '.market-card h3{display:flex;align-items:baseline;gap:10px;margin:0 0 10px;font-size:17px;color:#002766;}',
    '.market-card h3 span{font-size:12px;color:#0d5fc2;background:#eef5ff;border:1px solid #bfd3ef;border-radius:999px;padding:1px 8px;}',
    '.field{display:grid;grid-template-columns:90px 1fr;gap:10px;margin-top:7px;}',
    ...
    '@media(max-width:760px){.wrap{padding:12px}.article{padding:18px 16px}.field{grid-template-columns:1fr}.hero h1{font-size:20px}}',
    '</style>',
    '</head>',
    '<body>',

(() => {
  ...
  function enrich(report) {
    ...
    report.nikkeiPositiveContributors = arr(report.nikkeiPositiveContributors).length ? report.nikkeiPositiveContributors : [
      ...
      {name:'KDDI', contribution:'+16      {name:'中外製薬', contribution:'+15.19円', reason:'医薬品のディフェンシブ需要'},
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .cross-flow-layout{display:grid!important;grid-template-columns:minmax(0,1fr) 36px minmax(0,1fr)!important;gap:12px!important;align-items:stretch!important;width:100%!important}
      .cross-flow-panel{display:flex!important;flex-direction:column!important;width:100%!important;padding:16px 18px!important;border:1px solid #dce6f1!important;border-radius:14px!important;background:#fff!important}
      .cross-flow-panel h4{display:flex!important;align-items:center!important;gap:8px!important;margin:0 0 10px!important;font-size:15px!important;line-height:1.4!important}
      .cross-flow-panel p{margin:0!important;font-size:14px!important;line-height:1.8!important;color:#34465e!important}
      .cross-flow-panel--out{background:linear-gradient(180deg,#fff7f8,#fff)!important;border-color:#efcbd1!important}
      .cross-flow-panel--out h4{color:#b73c50!important}
      .cross-flow-panel--in{background:linear-gradient(180deg,#f3fbf6,#fff)!important;border-color:#c8e8d7!important}
      .cross-flow-panel--in h4{color:#17784c!important}
      .cross-flow-arrow{display:flex!important;align-items:center!important;justify-content:center!important;font-size:24px!important;font-weight:800!important;color:#2f6fd6!important}
      .cross-flow-summary{grid-column:1/-1!important;margin-top:2px!important;padding:14px 16px!important;border:1px solid #cbdcf1!important;border-left:4px solid #2f6fd6!important;border-radius:12px!important;background:#f5f9ff!important}
      .cross-flow-summary strong{display:block!important;margin-bottom:5px!important;color:#245aa7!important}
      .cross-flow-summary p{margin:0!important;font-size:13px!important;line-height:1.75!important;color:#34465e!important}
      .contribution-row{display:grid!important;grid-template-columns:28px minmax(0,1fr) auto!important;gap:10px!important;align-items:start!important;padding:12px 0:grid!important;grid-template-columns:28px minmax(0,1fr) auto!important;gap:10px!important;align-items:start!important;padding:12px 0!important;border-bottom:1px solid #edf2f7!important}
      ...
      @media(max-width:700px){
        ...
        #dashboardFlow .flow-node-card{padding:15px!important;border-radius:12px!important}
  ...
  function parseFlow(raw) {
    ...
    if (!sentence) return {source:'取得不能', destination:'取得不能', summary:''};
  ...
  function renderFlow(report) {
    ...
    const flow = parseFlow(rows.join(' '));
    target.innerHTML = `
      <div class="capital-flow-map">

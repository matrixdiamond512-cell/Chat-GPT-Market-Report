...
function render(d,market,stocks){
 ...
 <section class="nikkei-grid">
  <article class="nikkei-card nikkei-span-7"><div class="nikkei-section-head"><h2 class="nikkei-section-title">1. 日経225先物需給</h2>${freq('日次','daily')}</div><div class="nikkei-section-body nikkei-futures-layout">
  ...
  <article class="nikkei-card nikkei-span-5"><div class="nikkei-section-head"><h2 class="nikkei-section-title">2. 日中 vs ナイトセッション</h2>${freq('日次','daily')}</div><div class="nikkei-section-body"><div class="nikkei-session-grid">
  ...
  <article class="nikkei-card nikkei-span-5"><div class="nikkei-section-head"><h2 class="nikkei-section-title">3. 現物・先物ベーシス</h2>${freq('日次','daily')}</div><div class="nikkei-section-body"><div class="nikkei-basis-grid">
  ...
  <article class="nikkei-card nikkei-span-7"><div class="nikkei-section-head"><h2 class="nikkei-section-title">4. 裁定取引</h2>${freq('前々営業日','delayed')}</div><div class="nikkei-section-body"><div class="nikkei-table-scroll"><table class="nikkei-table"><thead><tr><th>項目</th><th>残高</th><th>前回比</th></tr></thead><tbody>
  ...
  <article class="nikkei-card nikkei-span-5"><div class="nikkei-section-head"><h2 class="nikkei-section-title">5. オプション・SQ需給</h2>${freq('日次','daily')}</div><div class="nikkei-section-body"><div class="nikkei-mini-grid">
  ...
  <article class="nikkei-card nikkei-span-6"><div class="nikkei-section-head"><h2 class="nikkei-section-title">6. 取引参加者別手口</h2>${freq('日次','daily')}</div><div class="nikkei-section-body"><div class="nikkei-rank-grid"><div class="nikkei-rank-box"><div class="nikkei-rank-title">売り上位</div>${rankRows(part.sellers,'sell')}</div><div class="nikkei-rank-box"><div class="nikkei-rank-title">買い上位</div>${rankRows(part.buyers,'buy')}</div></div><div class="nikkei-note">手口は最終投資家を直接示すものではありません。証券会社名から投資家の国籍や最終顧客を断定しません。</div>${source(part)}</div></article>
  <article class="nikkei-card nikkei-span-6"><div class="nikkei-section-head"><h2 class="nikkei-section-title">7. 海外投資家の週次需給</h2>${freq('週次','weekly')}</div><div class="nikkei-section-body"><div class="nikkei-table-scroll"><table class="nikkei-table"><thead><tr><th>市場</th><th>差引</th><th>評価</th></tr></thead><tbody>
  ...
  <article class="nikkei-card nikkei-span-6"><div class="nikkei-section-head"><h2 class="nikkei-section-title">8. 取引参加者別 建玉上位</h2>${freq('週次','weekly')}</div><div class="nikkei-section-body"><div class="nikkei-rank-grid"><div class="nikkei-rank-box"><div class="nikkei-rank-title">買い建玉上位</div>${rankRows(poi.buyers,'buy')}</div><div class="nikkei-rank-box"><div class="nikkei-rank-title">売り建玉上位</div>${rankRows(poi.sellers,'sell')}</div></div><div class="nikkei-note">${esc(poi.comment||'上位参加者への集中度と前週からの増減を確認します。')}</div>${source(poi)}</div></article>
  <article class="nikkei-card nikkei-span-6"><div class="nikkei-section-head"><h2 class="nikkei-section-title">9. 空売り・信用需給</h2>${freq('日次 / 週次','weekly')}</div><div class="nikkei-section-body"><div class="nikkei-mini-grid">
 ...
 <article class="nikkei-card nikkei-ai"><div class="nikkei-section-head"><h2 class="nikkei-section-title">10. AI需給コメント / 次の監視ポイント</h2>${freq('更新時判定','daily')}</div><div class="nikkei-section-body nikkei-ai-grid">

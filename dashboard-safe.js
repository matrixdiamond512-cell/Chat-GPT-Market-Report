...
<section class="safe-controls"><label>ダッシュボード表示レポート<select id="reportSelect">${reportOptions(r)}</select></label><div class="control-links"><a class="volume-btn" href="usdjpy-volume.html">東京市場ドル円出来高分析</a><button type="button" data-action="text">図解テキスト版</button><button type="button" data-action="history">履歴</button></div></section>
